<a href="#" class="btnDetalle" onclick="openModalDetalleSolicitudCanje(this)">Ver detalle
...
<script>
	function openModalDetalleSolicitudCanje(btnDetalle) {
		const fila = btnDetalle.closest('tr');
		const celdaCodigoSolicitudCanje = fila.getElementsByClassName('idSolicitudCanje')[0]; 
		const codigoSolicitudCanje = celdaCodigoSolicitudCanje.innerText;
		
		objSolicitudCanjeAndDetailsByIdSolicitudCanjeFetch(codigoSolicitudCanje);
	}
</script>