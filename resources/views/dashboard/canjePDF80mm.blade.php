...
<head>
	...
	<link rel="stylesheet" href="{{ public_path('css/canjePDF80mm.css') }}" type="text/css">
</head>
...
<body>
	...
	<table class="tblSecondRowCanjePDF">
		<tbody>
			...
			<tr>
				<td>
					<h2>F. y H. DE EMISIÓN VENTA INTERMEDIADA</h2>
				</td>
				<td>
			...
			<tbody>
				@foreach ($canjesRecompensas as $canjRecom)
					<tr>
						...
						<td class="celda-centered">{{ $canjRecom->nombre_TipoRecompensa }}</td>
