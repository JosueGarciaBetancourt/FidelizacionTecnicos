...
return [
    ...
    */
    ...
    | los atributos utilizando la convención "attribute.rule" para
    | nombrar las líneas. Esto facilita la especificación de
    | una línea de idioma personalizada para una regla dada.
    |
    */
    ...
    | nuestro marcador de posición de atributo
    | por algo más legible, como "Dirección de correo electrónico" en
    | lugar de "email". Esto simplemente ayuda a que nuestro mensaje
    | sea más expresivo.
    |
    */
